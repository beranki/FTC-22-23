...
@Autonomous(name = "Autonomous 1.0 -> A5 & F2 (untested - LC)")
public class AutonomousBlue2 extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        while (opModeIsActive()) {
            ...
            slideMotor.setTargetPosition((int) (COUNTS_PER_INCH * 18.5)*720/288);
            ...
            moveLeft(power*1.5, (int)(trm.getCurrentPosition() + 14*COUNTS_PER_INCH));
            moveForward(power, (int)(trm.getCurrentPosition() + 23*COUNTS_PER_INCH));
